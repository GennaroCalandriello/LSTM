...
LR = 0.001
EPOCHS = 5000
N_INT, N_BC, N_IC = 1000, 4000, 4000
T_max = 0.5
SEQ_LEN = 20
NX = 400
NT = 200
...
Z_LB, Z_UB = X_LB, X_UB
T_LB, T_UB = 0.0, 10
cx, cy, r = 0.0, 0.0, 1 #circle center and radius
...
N_SAMPLES = 1000
N_COLLOCATION = 20000 #number of collocation points, generally 1000-10000, 10000 for complex problems
